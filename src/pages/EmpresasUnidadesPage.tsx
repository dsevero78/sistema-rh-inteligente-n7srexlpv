      ...
      <div className="bg-[#11162B] text-white p-5 rounded-xl border border-slate-800 shadow-md flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-300 mt-1 max-w-2xl">
            ...
            <strong className="text-white">Consolidado</strong>, os indicadores de Gente & Gestão
            somam todas as operações. Ao selecionar uma empresa específica, os vínculos e áreas são
            filtrados.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="bg-[#1A223B] border border-slate-700 rounded-lg p-2.5 flex items-center gap-3">
            <div className="text-right">
              <span className="text-[11px] text-slate-400 block">Comprometimento Mensal Grupo</span>
